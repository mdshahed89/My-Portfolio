    ...
    <div>
      <div className=" grid grid-cols-1 sm:grid-cols-2 gap-4 ">
        ...
        <Blog
          ...
          details="Dive into the world of asynchronous programming in JavaScript with this in-depth tutorial. Learn how to handle asynchronous..."
          react="3k"
        />
        <Blog
          img={BlogImg3}
          time="6th June, 2024"
          title="Mastering React: From Beginner to Advanced"
          details="Unlock the full potential of React by starting with the basics and progressing to advanced concepts. This comprehensive guide covers everything from creating your first React component to optimizing performance and managing state with Redux. Whether you're a beginner or looking to enhance your skills, this journey through React will equip you with the knowledge to build robust and scalable applications."
          react="2k"
        />
        <Blog
          img={BlogImg4}
          time="3th June, 2024"
          title="Revolutionizing Agreements in the Digital Age"
          details="Discover the world of smart contracts and how they are transforming the way agreements are made and executed. This blog explains the mechanics of smart contracts on blockchain platforms like Ethereum, highlighting their benefits, real-world use cases, and the challenges they face. Learn how smart contracts are enabling trustless and automated transactions across various industries."
          react="5k"
        />
        <Blog
          img={BlogImg5}
